...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2025 at 10:32 AM
...
(38, 8, '', 'test', 'Kedah', '14300', '0192829101', 1),
...
(4, 42, 1, 'Brand:  → Bouquet', NULL),
(5, 42, 1, 'Brand:  → Bouquet, Stock: 0 → 9', NULL),
(6, 42, 1, 'Brand:  → Bouquet, Discount: 0% → 9%', NULL),
(7, 42, 1, 'Brand:  → Bouquet, Stock: 0 → 9', NULL),
(8, 42, 1, 'Brand:  → Bouquet, Discount: 0% → 9%', NULL),
(9, 42, 1, 'Brand:  → Bouquet, Stock: 0 → 9', NULL),
(10, 42, 1, 'Brand:  → Bouquet, Stock: 0 → 9', NULL);
...
(1, '../assets/image/homeScreen/imagePoster1.jpg', 'Walk in Confidence with Our High-Quality Shoes!', 'image');
...
(41, 'Key Chain', 20.00, 5, 1, 10, 'key chain'),
(42, 'Rose bouquet Red', 0.00, 9, 2, 9, 'bouquet'),
(43, 'Kobe', 999.00, 1, 0, 9, 'bouquet');
...
(99, 42, '../assets/image/uploads/681326daf37fb.jpg'),
(101, 43, '../assets/image/uploads/68132e6121fb1.jpg');
...
(8, 'Yipik', 'yp123@gmail.com', '0192829101', '7c222fb2927d828af22f592134e8932480637c0d', 'user', '/assets/image/uploads/oYvnRAYD2Q4ACMdePDIAgeGdADSLICPfIAcBe3~tplv-dy-aweme-images_q75.webp', '2025-04-18 08:13:47'),
