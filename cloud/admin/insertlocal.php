...
if (isset($_POST['packagename'])){
    ...
    $sql ="INSERT INTO `tbllocal` (`PackageID`, `PackageName`, `Price`, `Extra1`, `PackageImg`) 
    VALUES ('".$p."','".$pn."', '".$price."', '".$extra1."', '".$imgloc."')"; 
    mysqli_select_db($conn,"myproject"); 
    $result=mysqli_query($conn,$sql);  
    goto2("viewlocal.php?UserID=$id","Product is successfully inserted");
    }
    else{
    $sql ="INSERT INTO `tbllocal` (`PackageID`, `PackageName`, `Price`, `Extra1`) 
    VALUES ('".$p."','".$pn."', '".$price."', '".$extra1."')"; 
    mysqli_select_db($conn,"myproject"); 
    $result=mysqli_query($conn,$sql);  
    goto2("viewlocal.php?UserID=$id","Product is successfully inserted");
    }
