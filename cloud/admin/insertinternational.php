...
<head>
<title>Insert International</title>
</head>
<body>
...
<div class="row">
<div class="admin-det">
<h1>Insert International Package</h1>
<?php 
...
if (isset($_POST['packagename'])){
    ...
    $sql ="INSERT INTO `tblinternational` (`PackageID`, `PackageName`, `Country`, `StartDate`, `EndDate`, `Price`, `Extra1`, `Extra2`, `Extra3`, `Extra4`, `Extra5`, `PackageImg`) 
    VALUES ('".$p."','".$pn."','".$c."', '".$startdate."', '".$enddate."', '".$price."', '".$extra1."', '".$extra2."','".$extra3."','".$extra4."','".$extra5."','".$imgloc."')";  // sql insert command
    mysqli_select_db($conn,"myproject"); 
    $result=mysqli_query($conn,$sql);  
    goto2("viewinternational.php?UserID=$id","International package is successfully inserted");
    }
    else{
    $sql ="INSERT INTO `tblinternational` (`PackageID`, `PackageName`, `Country`, `StartDate`, `EndDate`, `Price`, `Extra1`, `Extra2`, `Extra3`, `Extra4`, `Extra5`) 
    VALUES ('".$p."','".$pn."','".$c."', '".$startdate."', '".$enddate."', '".$price."', '".$extra1."', '".$extra2."','".$extra3."','".$extra4."','".$extra5."')";  // sql insert command
    mysqli_select_db($conn,"myproject"); 
    $result=mysqli_query($conn,$sql);  
    goto2("viewinternational.php?UserID=$id","International package is successfully inserted");
    }
...
?>
<form action="insertinternational.php?UserID=<?php echo $id?>" method="POST" enctype="multipart/form-data">
